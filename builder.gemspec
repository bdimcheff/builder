...
* XML Events
  ...
  s.extra_rdoc_files = ["CHANGES", "Rakefile", "README.rdoc", "TAGS", "doc/releases/builder-1.2.4.rdoc", "doc/releases/builder-2.0.0.rdoc", "doc/releases/builder-2.1.1.rdoc"]
  s.files = ["lib/blankslate.rb", "lib/builder/blankslate.rb", "lib/builder/xchar.rb", "lib/builder/xmlbase.rb", "lib/builder/xmlevents.rb", "lib/builder/xmlmarkup.rb", "lib/builder.rb", "test/performance.rb", "test/preload.rb", "test/test_blankslate.rb", "test/test_cssbuilder.rb", "test/test_eventbuilder.rb", "test/test_markupbuilder.rb", "test/test_namecollision.rb", "test/test_xchar.rb", "CHANGES", "Rakefile", "README.rdoc", "TAGS", "doc/releases/builder-1.2.4.rdoc", "doc/releases/builder-2.0.0.rdoc", "doc/releases/builder-2.1.1.rdoc"]
